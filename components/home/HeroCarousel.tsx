...
export type HeroCarouselProps = { className?: string };
...
export function HeroCarousel({ className }: HeroCarouselProps) {
  ...
  return (
    ...
    >
      ...
      {/* Years-of-service medallion */}
      <div
        aria-label={`${BRAND.yearsInBusiness}+ years of trusted service`}
            ...
            {HERO_SLIDES.map((slide, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === index ? "bg-brand-blue w-5" : "w-2 bg-neutral-400/70 hover:bg-neutral-500",
                )}
              />
            ))}
          </div>
