...
export type StoreInfoProps = { settings: SiteSettings };

/** Server Component. Where the shop is and how to call it, from the store settings. */
    ...
    <div className="grid h-full gap-4 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm sm:grid-cols-2">
      <div className="flex gap-3">
        ...
        <div className="text-sm">
          ...
          <p className="mt-0.5 text-neutral-600">{settings.addressLine}</p>
          <a
