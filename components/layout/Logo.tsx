...
export type LogoProps = {
  ...
  tone?: "color" | "light";
  /** Hide the tagline (mobile header). */
  compact?: boolean;
  className?: string;
};
...
export function LogoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" aria-hidden="true" focusable="false" className={className}>
      ...
      <path d="M24 10.5 9.5 22v18.5h29V22L24 10.5Z" fill="currentColor" className="opacity-0" />
      <path
...
/** Server-safe wordmark + mark. Always links home. */
